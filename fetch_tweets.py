...
class twitterAuthentication():
	...
	def authenticate_twitter_app(self):
		auth = OAuthHandler(KEYS_TOKENS.CONSUMER_KEY,KEYS_TOKENS.CONSUMER_SECRET)
		auth.set_access_token(KEYS_TOKENS.ACCESS_TOKEN,KEYS_TOKENS.ACCESS_TOKEN_SECRET)
		return auth
...
class tweetAnalyzer():
	...
	def tweets_to_data_frame(self,tweets):
		...
		df['tweet'] = np.array([tweetAnalyzer().clean_tweet(tweet.full_text) for tweet in tweets])
